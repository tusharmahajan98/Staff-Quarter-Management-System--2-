...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE message_table set St_ID='" . $_POST['St_ID'] . "', Name='" . $_POST['Name'] . "', Room_Num='" . $_POST['Room_Num'] . "', Messages='" . $_POST['Messages'] . "' WHERE St_ID='" . $_POST['St_ID'] . "'");

include "disp.php";

}
$result = mysqli_query($conn,"SELECT * FROM message_table WHERE St_ID='" . $_GET['St_ID'] . "'");
...
<section class="sec">
Student ID: <br>
<input style="width: 50%; height:30px; " type="hidden" name="St_ID" class="txtField" value="<?php echo $row['St_ID']; ?>">
<input style="width: 50%; height:30x; " type="text" name="Name"  value="<?php echo $row['St_ID']; ?>">
<br>
Name: <br>
