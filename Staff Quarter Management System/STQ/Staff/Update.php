...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE staff set S_ID='" . $_POST['S_ID'] . "', Name='" . $_POST['Name'] . "', Address='" . $_POST['Address'] . "', Email='" . $_POST['Email'] . "' WHERE S_ID='" . $_POST['S_ID'] . "'");
...
<body>
<form name="frmUser" method="post" action="DispStaffOnly.php">
