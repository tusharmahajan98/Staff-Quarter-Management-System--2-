...
<body>
    ...
    <header class="header">
        <img src="images/clg_logo.png" alt style="height: 70px; width: 65px">
        <a href="#" class="logo" style="text-decoration: none;">Staff Quarter Managment</a>
 <nav class="navbar">
                    ...
                    <div class="col">
                        <div class="intro_content" style="width: 550px; margin-right: 172px;height: 415px;">
                            ...
                            <div class="intro_title">
                                <h3>GREETINGS</h3>
                                <h3>Welcome to the Staff Quarters at Sinhgad Institute of Management, Vadgaon Pune!</h3>
                            </div>
                            <div class="intro_text">
                                
                                <p>
                                    Hello and a warm welcome to your new home at our college's staff quarters! We're delighted to have you as part of our community. Here at Sinhgad, our staff quarters are designed to offer you not just a place to stay, but a place to relax, connect, and thrive.

                                    Our quarters are equipped with everything you need for a comfortable and convenient living experience, from well-furnished rooms and dedicated study spaces to common lounges and reliable maintenance support. Plus, our support staff is always on hand to assist you with any queries or needs you may have.
                                </p>
                            </div>
                        </div>
                        <div class="row">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3 align="left" style="padding: 5px 10px 5px 70px;">
                    Dear Staff Quarter Residents,<br>
                    As we approach Republic Day of India, we're excited to invite all residents to join us for a special celebration and feast to honor this important day in our nation's history. The celebration will be held on January 26th at the dining area, starting at 7:00 PM.
                    <br><br> To participate in the feast, you'll need to purchase a coupon for ₹50 from the office. This coupon will grant you a plate of delicious vegetarian Indian cuisine, featuring festive dishes like vegetable biryani, paneer tikka, and traditional sweets.
                    <br><br>Please note that coupons will be available for purchase from January 20th, on a first-come, first-served basis. We encourage you to secure your coupons early to ensure a spot at the celebration.
                    <br><br>If you have any questions or need more information, please feel free to reach out to the staff office. We look forward to celebrating Republic Day with everyone and making it a memorable evening!
                    <br><br>Best regards,
                    <br><br> Sinhgad Institute of Management Staff Quarters
                </h3>
            </div>
        </div>
    </section>
    ...
    <section class="hall" id="hall">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <h3>Chatrapati Shivaji Maharaj Hall</h3>
            </div>

            <div class="box">
                <img src="images/h2.jpg" alt="">
                <h3>Subedat Tanaji Malusare Hall</h3>
            </div>

            <div class="box">
                <img src="images/h3.jpg" alt="">
                <h3>Baji Prabhu Deshpande Hall</h3>
            </div>

            <div class="box">
                <img src="images/h4.jpg" alt="">
                <h3>Chatrapati Sambhaji Maharaj Hall</h3>
            </div>

            <div class="box">
                <img src="images/h5.jpg" alt="">
                <h3>Shiva Kashid Hall</h3>
            </div>

            <div class="box">
                <img src="images/h6.jpg" alt="">
                <h3>Shahid Bhagat-Singh Hall</h3>
            </div>


            <div class="box">
                <img src="images/h7.jpg" alt="">
                <h3>Dr.Babasaheb Ambedkar Hall</h3>
            </div>

            <div class="box">
                <img src="images/h8.jpg" alt="">
                <h3>Lokmanya Tilak Hall</h3>
            </div>

            <div class="box">
                <img src="images/h9.jpg" alt="">
                <h3>Swatantya Veer Savarkar Hall</h3>
            </div>
            ...
            <div class="position-relative d-flex align-items-center justify-content-center" id="sec_cond1">
                <div class="row portfolio-container" id="room">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 portfolio-item second" id="canteen">
                        <div class="position-relative overflow-hidden mb-2">
                            <img class="img-fluid rounded w-100" src="images/canteen12.jpg" alt="">
                            <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
                                <a href="images/canteen12.jpg" data-lightbox="portfolio">
                                    <i class="fa fa-plus text-white" style="font-size: 60px;"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 portfolio-item third" id="canteen">
                        <div class="position-relative overflow-hidden mb-2">
                            <img class="img-fluid rounded w-100" src="images/canteen13.jpg" alt="">
                            <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
                                <a href="images/canteen13.jpg" data-lightbox="portfolio">
                                    <i class="fa fa-plus text-white" style="font-size: 60px;"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 portfolio-item third" id="canteen">
                        <div class="position-relative overflow-hidden mb-2">
                            <img class="img-fluid rounded w-100" src="images/canteen14.jpg" alt="">
                            <div class="portfolio-btn bg-primary d-flex align-items-center justify-content-center">
                                <a href="images/canteen14.jpg" data-lightbox="portfolio">
                                    <i class="fa fa-plus text-white" style="font-size: 60px;"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Sinhgad Institute Of Management, Vadagaon(Pune)</p>
                            </div>

                            <div class="mail">
                                <i class="bx bx-envelope"></i>
                                <h4>mail:</h4>
                                <p>siom@sinhgad.edu</p>
                            </div>
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2710.187612604349!2d73.8354938!3d18.4651952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc295ed8144aebd%3A0xa33411c6a455191!2sSinhgad%20Institute%20of%20Management%20(SIOM)!5e1!3m2!1smr!2sin!4v1731126863757!5m2!1smr!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                        ...
                        <form action="message/message.php" method="post" role="form" class="php-email-form">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="email" class="message">Email ID</label>
                                    <input type="text" name="email" class="form-control" id="email" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                    <div class="validate"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="Name" class="message">Staff Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="Room_Num" id="Room_Num" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                                <div class="validate"></div>
                            </div>
                            <div class="form-group">
                                <label for="Floor_Num" class="message">Floor Number</label>
                                <input type="number" class="form-control" name="Floor_Num" id="Floor_Num" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                                <div class="validate"></div>
                            </div>
                            <div class="form-group">
                                <label for="Messages" class="message">complaint box</label>
                            ...
                            <div class="text-center" id="button_mes"><button type="submit">Send</button></div>
                        </form>
                    </div>
    ...
    <section class="footer" id="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#" style="text-decoration: none;"> <i class="fas fa-phone" style="text-decoration: none;"></i> 02024356592 </a>
                <a href="#" style="text-decoration: none;"> <i class="fas fa-envelope"></i> Siom@Sinhgad.edu </a>
                <a href="https://www.google.com/maps/place/Shaheed+Salam+Barkat+Hall/@23.8823987,90.2620247,17z/data=!3m1!4b1!4m5!3m4!1s0x3755e9a02b7f1e89:0x6d20e40f3a231f37!8m2!3d23.8823987!4d90.2642134" style="text-decoration: none;"> <i class="fas fa-map-marker-alt"></i>S. No. 44/1, Vadgaon (Bk.), Off. Sinhgad Rd.,
                Pune – 411041 Maharashtra, INDIA </a>
            </div>
