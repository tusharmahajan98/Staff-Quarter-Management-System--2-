...
<body>
     ...
     <div class="slidebar">
        ...
        <!-- Display logged-in user's full name securely -->
          ...
          <ul>
               <li>
                    <a href="../Admin_Details/DispProvost.php" style="text-decoration:none"><i class="fas fa-user-tie"></i> Admin Details </a>
               </li>
               <li>
               ...
               <li>
                    <a href="../Staff/DispStaff.php" style="text-decoration:none"><i class="fas fa-book-reader"></i> Staff Request</a>
               </li>
               <li>
               ...
               <li>
                    <a href="../message/disp.php" style="text-decoration:none"><i class="fas fa-envelope-open"></i> Complaint Box</a>
               </li>
          </ul>
               ...
               <a href="../Staff/DispStaff.php" rel="" style="text-decoration:none">
                    <div class="cardspecific" style="width: 26%;">
                         ...
                         <div class="number">
                              <?php
                              include 'connection.php';
                              $sql = "select count(*) as total from staff_requests";
                              $result = mysqli_query($conn, $sql);
                              $data = mysqli_fetch_assoc($result);
                              echo $data['total'];
                              ?>
